...
class image_controller extends Controller
{
    public function upload_image(Request $request) {
        ...
        // return response()->json(["result"=>"error","message"=>$name_model_id.'-'.$model.'-'.$request->model_id]);
        $image = new Image;
        ...
        $html = view('admin.images.card_image',compact('image'))->render();
    ...
    public function delete_image(Request $request)
    {
        ...
        $html = view('admin.images.images_load',compact('images','model','model_id'))->render();
        return response()->json(["result"=>"html","viewReplace"=>".images_load","html"=>$html,"message"=>trans("message.Elemento eliminado")]);

    }

    public function set_image_as_primary(Request $request){
        $image_id = $request->image_id;
        $model = $request->model;
        $model_id = $request->model_id;
        $name_model_id = $request->model.'_id';
    ...
    public function delete_all_images($model,$model_id)
    {

        $name_model_id = $model.'_id';
        $images = Image::where($name_model_id,$model_id)->get();
